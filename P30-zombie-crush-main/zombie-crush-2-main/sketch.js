...
function preload() {
  uglytroll = loadImage("./assets/uglytroll.png");
...
function setup() {
  ...
  zombie = createSprite(width / 2, height - 105);
  zombie.addAnimation("lefttoright", uglytroll2, uglytroll2);
  zombie.addAnimation("righttoleft", uglytroll, uglytroll);
  zombie.scale = 0.27;
  zombie.velocityX = 10;
